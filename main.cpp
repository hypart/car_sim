...
int main(int argc, const char* argv[]) {
    ...
    carBase car = carBase(1 / (dispFPS * phys_per_disp_FPS), dispFPS, 4.0, 1.75, 1500.0f, 0.0005,
    ...
    while (!WindowShouldClose()) {
        ...
        Eigen::Vector3f cam_dir = Eigen::AngleAxisf(cam_yaw, Eigen::Vector3f(0.0f, 0.0f, 1.0f)) *
        ...
        DrawText(TextFormat("throttle: %.0f%%", car.drivetrain.throttle * 100.0f), 220, 10, 20,
                 WHITE);
        DrawText(TextFormat("clutch: %.0f%% engaged", car.drivetrain.clutch * 100.0f), 220, 40, 20,
                 WHITE);
        EndDrawing();
